...
public class CycleView extends View {
	 ...
	 * 画进度百分比
	 */
	private void drawPercent(Canvas canvas, int centre, int radius) {
	 ...
	 * 画圆弧 ，画圆环的进度
	 */
	private void drawArc(Canvas canvas, int centre, int radius) {
		...
		case FILL: {
			...
			RectF oval = new RectF(centre - radius + roundWidth, centre
					- radius + roundWidth, centre + radius - roundWidth, centre
					+ radius - roundWidth); // 用于定义的圆弧的形状和大小的界限
	...
	protected void onDraw(Canvas canvas) {
		...
		drawOutCycle(canvas, centre, radius);
		drawPercent(canvas, centre, radius);
		drawArc(canvas, centre, radius);
	}
